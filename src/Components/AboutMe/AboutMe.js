    ...
    <>
      ...
      <div className="journey-container">
        <div className="journey-card">
          ...
          <div>
            The program spans 5 ½ years and offers a comprehensive journey that
            merges business management with technological innovation.
          </div>
        </div>
        ...
        <div className="journey-card">
          ...
          <div>
            Dedicating over 60 hours to mastering React Js with both CoderHouse
            and Meta courses.
          </div>
          <div>
            Gained a solid understanding of web development fundamentals,
            including HTML, CSS, and SASS, through a 38-hour course. Participated
            in bootcamps for Object Orented Prgramming and courses for backend languages such as Python.
          </div>
        </div>
        <img src={Arrow} alt="Logo" className="logo-image" />{" "}
        <div className="journey-card">
          ...
          <div>
            ...
            proficiency, enabling me to fluently communicate both orally and in
            writing. This proficiency is certified by TOEFL and IGCSE English
            exams I have taken. Additionally, I have an elementary level of
            Portuguese, allowing me to engage in basic conversations.
          </div>
          <div></div>
        </div>
        <img src={Arrow} alt="Logo" className="logo-image" />{" "}
        <div className="journey-card">
          ...
          <div>
          In the last two and a half years, I have been working in multinational companies, improving my skills in software development.
          </div>
        </div>
      </div>
